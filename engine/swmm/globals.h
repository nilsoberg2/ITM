...
EXTERN int
                  ...
                  OutputFlowUnits,          // Flow units for return value of certain subroutines
...
// ITM OPTIONS
EXTERN int
                  MinNumGrids,              // Minimum number of grids
                  MaxNumCells,              // Maximum number of cells per pipe
                  MaxNumIterations,         // Maximum number of iterations allowed for solution
                  MaxNumPlotCells,          // Maximum number of cells to save to plot-file per pipe
				  ITMFlowType;				// Type of flow (pressurized, free-surface, mixed)
EXTERN double
                  PressurizedWaveCelerity,  // Pressure wave celerity, fully pressurized flows
                  MixedFlowWaveCelerity,    // Pressure wave celerity, mixed flow conditions
                  RefDepthFraction,         // Reference depth fraction
				  WaterInitElevation,		// Initial water elevation (not depth)
                  ITMTolNormal,
                  ITMTolLow,
                  ITMTolVeryLow,
                  ITMTolHigh,
...
EXTERN TRatingUnit* RatingUnit;             // Array of rating unit nodes
