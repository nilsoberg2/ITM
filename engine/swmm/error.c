...
#define ERR115 "\n  ERROR 115: adverse slope in link. Change direction of Arrow %s."
...
#define ERR135 "\n  ERROR 135: Gate %s does not have correct parameters."
...
#define ERR181 "\n  ERROR 181: invalid Snow Melt Climatology parameters."      //(5.0.012 - LR)
#define ERR182 "\n  ERROR 182: invalid parameters for Snow Pack %s."           //(5.0.012 - LR)

#define ERR901 "\n  ERROR 901: an error in the ITM engine was detected at time %s."
...
#define MAXERRMSG 87  // highest sequential index of error codes               //(5.0.012 - LR)
...
char* ErrorMsgs[] =
    { "",     ERR101, ERR103, ERR105, ERR107, ERR108,
      ...
      ERR401, ERR402, ERR403, ERR405, ERR181,
      ERR182, ERR901};
