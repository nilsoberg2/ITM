...
////BEGIN ITM CODE
                               // ITM OPTION WORDS
                               w_MIN_NUM_GRIDS,
                               w_MAX_NUM_ITERATIONS,
                               w_MAX_NUM_CELLS,
                               w_PRESSURIZED_WAVE_CELERITY,
                               w_MIXED_FLOW_WAVE_CELERITY,
                               w_REF_DEPTH_FRACTION,
                               w_MAX_NUM_PLOT_CELLS,
                               w_ITM_TOL_NORMAL,
                               w_ITM_TOL_LOW,
                               w_ITM_TOL_VERY_LOW,
                               w_ITM_TOL_HIGH,
                               w_ITM_TOL_TRANSITION,
							   w_WATER_INIT_ELEVATION,
							   w_ITM_FLOW_TYPE,
							   w_ROUTE_STEP_MS,
////END ITM CODE
                               NULL
...
////BEGIN ITM CODE
char* InitialDepthWords[]  = { w_INIDEP_CRITICAL, w_INIDEP_NORMAL, w_INIDEP_CONSTANT, NULL };
char* BoundaryConditionWords[] = {
                                w_JUNC_BC_JUNCTION,     w_JUNC_BC_DROPSHAFT,
                                w_JUNC_BC_CONST_FLOW,   w_JUNC_BC_CONST_DEPTH,
                                w_JUNC_BC_RESERVOIR,
                                NULL };
char* BoundaryOpenWords[]  = { w_JUNC_DS_VENT_YES, w_JUNC_DS_VENT_NO, NULL };
char* FlowTypeWords[] = { w_FLOW_TYPE_FREE_SURFACE, w_FLOW_TYPE_MIXED, w_FLOW_TYPE_PRESSURIZED, NULL };

////END ITM CODE

char* FlowUnitWords[]      = { w_CMS, w_LPS, w_MLD, w_CFS, w_GPM, w_MGD, NULL};
